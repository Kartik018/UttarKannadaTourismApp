package com.example.tourismapp.ui.Yellapur;
...
public class YellapurFragment extends Fragment {

    RecyclerView recyclerView;
    alladaptor adapter;
    public YellapurFragment(){
...
//        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        FirebaseRecyclerOptions<alldatamodel> options =
                new FirebaseRecyclerOptions.Builder<alldatamodel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Yellapur"), alldatamodel.class)
                        .build();
