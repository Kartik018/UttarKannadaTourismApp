package com.example.tourismapp.ui.Ankola;
...
public class AnkolaFragment extends Fragment {

    RecyclerView recyclerView;
    alladaptor adapter;
    public AnkolaFragment(){
...
//        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        FirebaseRecyclerOptions<alldatamodel> options =
                new FirebaseRecyclerOptions.Builder<alldatamodel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Ankola"), alldatamodel.class)
                        .build();
