package com.example.tourismapp.ui.Dandeli;
...
public class DandeliFragment extends Fragment {
    RecyclerView recyclerView;
    alladaptor adapter;
    public DandeliFragment(){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FirebaseRecyclerOptions<alldatamodel> options =
                new FirebaseRecyclerOptions.Builder<alldatamodel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Dandeli"), alldatamodel.class)
                        .build();
