package com.example.tourismapp.ui.Joida;
...
public class JoidaFragment extends Fragment {
    RecyclerView recyclerView;
    alladaptor adapter;
    public JoidaFragment(){
...
//        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        FirebaseRecyclerOptions<alldatamodel> options =
                new FirebaseRecyclerOptions.Builder<alldatamodel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Joida"), alldatamodel.class)
                        .build();
