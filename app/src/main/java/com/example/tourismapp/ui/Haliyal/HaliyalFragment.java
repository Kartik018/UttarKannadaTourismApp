package com.example.tourismapp.ui.Haliyal;
...
public class HaliyalFragment extends Fragment {

    RecyclerView recyclerView;
    alladaptor adapter;
    public HaliyalFragment(){
...
//        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        FirebaseRecyclerOptions<alldatamodel> options =
                new FirebaseRecyclerOptions.Builder<alldatamodel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Haliyal"), alldatamodel.class)
                        .build();
