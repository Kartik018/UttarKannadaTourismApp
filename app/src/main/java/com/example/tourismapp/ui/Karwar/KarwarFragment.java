package com.example.tourismapp.ui.Karwar;
...
public class KarwarFragment extends Fragment {

    RecyclerView recyclerView;
    alladaptor adapter;
    public KarwarFragment(){
...
//        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        FirebaseRecyclerOptions<alldatamodel> options =
                new FirebaseRecyclerOptions.Builder<alldatamodel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Karwar"), alldatamodel.class)
                        .build();
