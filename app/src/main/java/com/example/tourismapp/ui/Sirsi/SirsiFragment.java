package com.example.tourismapp.ui.Sirsi;
...
public class SirsiFragment extends Fragment
{
    RecyclerView recyclerView;
    alladaptor adapter;
    public SirsiFragment(){
...
//        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        FirebaseRecyclerOptions<alldatamodel> options =
                new FirebaseRecyclerOptions.Builder<alldatamodel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Sirsi"), alldatamodel.class)
                        .build();
