package com.example.tourismapp.ui.Mundgod;
...
public class MundgodFragment extends Fragment {

    RecyclerView recyclerView;
    alladaptor adapter;
    public MundgodFragment(){
...
//        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        FirebaseRecyclerOptions<alldatamodel> options =
                new FirebaseRecyclerOptions.Builder<alldatamodel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Mundgod"), alldatamodel.class)
                        .build();
