package com.example.tourismapp.ui.Kumta;
...
public class Kumta_Fragment extends Fragment {

    RecyclerView recyclerView;
    alladaptor adapter;
    public Kumta_Fragment(){
...
//        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        ...
        FirebaseRecyclerOptions<alldatamodel> options =
                new FirebaseRecyclerOptions.Builder<alldatamodel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Kumta"), alldatamodel.class)
                        .build();
